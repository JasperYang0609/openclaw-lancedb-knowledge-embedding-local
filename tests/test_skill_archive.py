...
def main() -> None:
    with zipfile.ZipFile(OUTPUT, "r") as packaged:
        ...
        for required in (
            ...
            "assets/knowledge-lancedb-template/scripts/snapshot_knowledge_assets.py",
            "assets/knowledge-lancedb-template/scripts/knowledge_index_incremental.sh",
            "assets/knowledge-lancedb-template/scripts/knowledge_index_full.sh",
